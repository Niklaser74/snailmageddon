...
const dict = {
  sv: {
    ...
    'pad.connected': 'Handkontroll ansluten: styrkors/spak gå och sikta, A skjut, B hoppa, LB/RB vapen, högerspak kamera, Start meny.',
    'menu.theme': 'Terräng', 'theme.auto': 'Slumpad', 'theme.garden': 'Trädgårdsland', 'theme.beach': 'Strand', 'theme.jungle': 'Regnskog',
    'menu.turnTime': 'Dragtid', 'menu.sudden': 'Plötslig död', 'menu.wind': 'Vind',
    'wind.normal': 'Normal', 'wind.hard': 'Hård (1,8×)', 'wind.storm': 'Storm (2,5×, alla kast driver)', 'menu.volume': 'Ljudvolym', 'menu.seconds': '{n} s',
    ...
    'help.7': '<b>Handkontroll:</b> styrkors/spak gå och sikta, A skjut, B hoppa, LB/RB vapen, högerspak kamera, Start meny. <b>Kamera:</b> dra med musen/fingret för att panorera, scrolla eller nyp för att zooma. <b>Plötslig död:</b> efter 16 drag börjar vattnet stiga (ändras i menyn). <b>Ljud:</b> 🔊 i spelet stänger av, volymen ställs i menyn.',
    ...
    'hud.wind': 'Vind', 'hud.wind_hard': 'Hård vind', 'hud.wind_storm': 'Storm', 'hud.ai': '(dator)', 'hud.ai.easy': '(dator, lätt)', 'hud.ai.normal': '(dator)', 'hud.ai.hard': '(dator, svår)', 'hud.fire': 'SKJUT',
    ...
    'account.portal': 'Kontot finns bara i den här webbläsaren. Vill du spela på flera enheter? Koppla kontot på <a href="https://snails.se/account/" target="_blank" rel="noopener">snails.se/account</a> – ett konto för alla spelen.',
    'account.series': 'Ett konto för alla spel på snails.se. <a href="https://snails.se/account/?next=/snailmageddon/">Namn, utseende och koppling</a>.',
    ...
    'account.google': 'Fortsätt med Google', 'account.orEmail': '…eller med e-post:', 'account.confirm': 'Bekräfta',
    'account.linkedVia': 'Kontot är kopplat till {email} via Google. På en annan enhet: välj Fortsätt med Google.',
    'account.rateLimited': 'För många mejl just nu. Vänta en stund och försök igen, eller använd Fortsätt med Google.',
    'account.emailTaken': 'Adressen hör redan till ett konto. Välj Skicka inloggningslänk för att logga in som det.',
    'account.googleTaken': 'Det Google-kontot hör till ett annat spelarkonto. Loggar du in med det byts kontot på den här enheten; matcher du spelat anonymt här följer inte med.',
    'account.googleLogin': 'Logga in med det Google-kontot i stället',
    'account.confirmHint': 'Tryck på Bekräfta för att slutföra inloggningen från mejlet.',
    ...
    'cos.hat.none': 'Ingen', 'cos.hat.cap': 'Keps', 'cos.hat.party': 'Partyhatt', 'cos.hat.crown': 'Krona', 'cos.hat.viking': 'Vikingahjälm', 'cos.hat.tophat': 'Cylinder', 'cos.hat.laurel': 'Lagerkrans', 'cos.shell.confetti': 'Konfetti',
    'cos.awardRank': 'Topp 3 i rating en säsong', 'cos.awardDaily': 'Topp 3 i Dagens skott en säsong',
    'award.rank': '{season}: {place}:a i rating ({value})', 'award.daily': '{season}: {place}:a i Dagens skott ({value} p)', 'award.first': '{season}: 1:a', 'profile.awards': 'Utmärkelser:',
    'season.rewards': 'Belöningar vid säsongens slut: topp 3 i rating får lagerkransen, topp 3 i Dagens skott får konfettiskalet. Minst tre rankade matcher krävs.',
    'season.last': 'Förra säsongen ({season}):', 'season.lastNone': 'Förra säsongen delades inga belöningar ut.', 'season.kindRank': 'rating', 'season.kindDaily': 'Dagens skott',
    ...
    'profile.rank': 'Rank: {tier} ({rating}).',
    'cos.buy': 'Köp', 'cos.buyNeedsEmail': 'Koppla e-post först', 'cos.buying': 'Öppnar betalning…',
    'cos.bought': 'Tack för köpet! {item} är ditt.', 'cos.boughtWait': 'Betalningen är klar, väntar på bekräftelse…', 'cos.cancelled': 'Köpet avbröts. Inget har dragits.',
    'cos.buyError': 'Köpet gick inte att starta: {msg}', 'cos.buyOff': 'Betalning är inte påslagen än.',
    'season.title': 'Säsong', 'season.rank': 'Rank i Snigelpost', 'season.daily': 'Dagens skott, säsongspoäng',
    'season.blurb': 'Säsongen slutar {end}, {days} dagar kvar. Varje avslutad Snigelpost-match flyttar din rating. Dagens skott räknas ihop dag för dag.',
    'season.rankMe': 'Du: {tier} {rating}, plats {rank} av {total}. {games} matcher.', 'season.rankNone': 'Spela en Snigelpost-match för att få rating.',
    'season.dailyMe': 'Du: {points} p på {days} dagar, plats {rank} av {total}.', 'season.dailyNone': 'Skjut Dagens skott för att få säsongspoäng.',
    'season.empty': 'Ingen än. Bli först!', 'season.offline': 'Säsongen kräver uppkoppling.',
    'tier.slug': 'Slemhög', 'tier.garden': 'Trädgårdssnäcka', 'tier.warrior': 'Skalkrigare', 'tier.master': 'Saltmästare', 'tier.giant': 'Jättesnäcka',
  ...
  en: {
    ...
    'pad.connected': 'Gamepad connected: d-pad/stick to walk and aim, A fire, B jump, LB/RB weapons, right stick camera, Start menu.',
    'menu.theme': 'Terrain', 'theme.auto': 'Random', 'theme.garden': 'Garden', 'theme.beach': 'Beach', 'theme.jungle': 'Rainforest',
    'menu.turnTime': 'Turn time', 'menu.sudden': 'Sudden death', 'menu.wind': 'Wind',
    'wind.normal': 'Normal', 'wind.hard': 'Strong (1.8×)', 'wind.storm': 'Storm (2.5×, every throw drifts)', 'menu.volume': 'Sound volume', 'menu.seconds': '{n} s',
    ...
    'help.7': '<b>Gamepad:</b> d-pad/stick to walk and aim, A fire, B jump, LB/RB weapons, right stick camera, Start menu. <b>Camera:</b> drag with the mouse/finger to pan, scroll or pinch to zoom. <b>Sudden death:</b> after 16 turns the water starts rising (change it in the menu). <b>Sound:</b> 🔊 in the game mutes, the volume is set in the menu.',
    ...
    'hud.wind': 'Wind', 'hud.wind_hard': 'Strong wind', 'hud.wind_storm': 'Storm', 'hud.ai': '(computer)', 'hud.ai.easy': '(computer, easy)', 'hud.ai.normal': '(computer)', 'hud.ai.hard': '(computer, hard)', 'hud.fire': 'FIRE',
    ...
    'account.portal': 'Your account lives in this browser only. Want to play on several devices? Link the account at <a href="https://snails.se/account/" target="_blank" rel="noopener">snails.se/account</a> – one account for every game.',
    'account.series': 'One account for every game on snails.se. <a href="https://snails.se/account/?next=/snailmageddon/">Name, look and linking</a>.',
    ...
    'account.google': 'Continue with Google', 'account.orEmail': '…or with e-mail:', 'account.confirm': 'Confirm',
    'account.linkedVia': 'The account is linked to {email} via Google. On another device: choose Continue with Google.',
    'account.rateLimited': 'Too many e-mails right now. Wait a moment and try again, or use Continue with Google.',
    'account.emailTaken': 'That address already belongs to an account. Choose Send login link to sign in as it.',
    'account.googleTaken': 'That Google account belongs to another player account. Signing in with it switches the account on this device; matches played anonymously here will not follow.',
    'account.googleLogin': 'Sign in with that Google account instead',
    'account.confirmHint': 'Press Confirm to finish signing in from the e-mail.',
    ...
    'cos.hat.none': 'None', 'cos.hat.cap': 'Cap', 'cos.hat.party': 'Party hat', 'cos.hat.crown': 'Crown', 'cos.hat.viking': 'Viking helmet', 'cos.hat.tophat': 'Top hat', 'cos.hat.laurel': 'Laurel wreath', 'cos.shell.confetti': 'Confetti',
    'cos.awardRank': 'Top 3 in rating one season', 'cos.awardDaily': 'Top 3 in the shot of the day one season',
    'award.rank': '{season}: #{place} in rating ({value})', 'award.daily': '{season}: #{place} in the shot of the day ({value} pts)', 'award.first': '{season}: #1', 'profile.awards': 'Awards:',
    'season.rewards': 'Rewards at the end of the season: top 3 in rating get the laurel wreath, top 3 in the shot of the day get the confetti shell. At least three rated matches needed.',
    'season.last': 'Last season ({season}):', 'season.lastNone': 'No rewards were handed out last season.', 'season.kindRank': 'rating', 'season.kindDaily': 'shot of the day',
    ...
    'profile.rank': 'Rank: {tier} ({rating}).',
    'cos.buy': 'Buy', 'cos.buyNeedsEmail': 'Link an e-mail first', 'cos.buying': 'Opening payment…',
    'cos.bought': 'Thanks for your purchase! {item} is yours.', 'cos.boughtWait': 'Payment done, waiting for confirmation…', 'cos.cancelled': 'The purchase was cancelled. Nothing was charged.',
    'cos.buyError': 'The purchase could not start: {msg}', 'cos.buyOff': 'Payments are not switched on yet.',
    'season.title': 'Season', 'season.rank': 'Snail Mail rank', 'season.daily': 'Shot of the day, season points',
    'season.blurb': 'The season ends {end}, {days} days left. Every finished Snail Mail match moves your rating. Shot of the day points add up day by day.',
    'season.rankMe': 'You: {tier} {rating}, rank {rank} of {total}. {games} matches.', 'season.rankNone': 'Play a Snail Mail match to get a rating.',
    'season.dailyMe': 'You: {points} pts over {days} days, rank {rank} of {total}.', 'season.dailyNone': 'Take the shot of the day to earn season points.',
    'season.empty': 'Nobody yet. Be first!', 'season.offline': 'The season needs a connection.',
    'tier.slug': 'Slug pile', 'tier.garden': 'Garden snail', 'tier.warrior': 'Shell warrior', 'tier.master': 'Salt master', 'tier.giant': 'Giant snail',
